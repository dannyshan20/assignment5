...
I would drop pca 4, 5, and 6 because the variances are less than 1.
...
#We would. mean_correct is significantly correlated with PC4 and PC6 with r=.13, p<.05 and r=-.39, p<.001 respectively, dropping them will lead us to miss out the association between mean_correct with them.
```
...
tc <- tc[-c(69),-1]
pca_tc <- prcomp(tc, scale. = TRUE)
plot(pca_tc, type = "line")
#As eigenvalues showing the trend of stop decreasing so drastically after PC4, I will use PC 1-4 for analysis.
pca_tc$rotation[ , 1:4]
pca_df <- data.frame(abs(pca_tc$rotation[ , 1:4]))
#PC 1 cares more about politics, leadership, and education, as PC 2 has a greater interest on psychology, neuroscience, and biology. PC 3 likes art and design while also enjoys math and technology. PC 4's interests are on linguistic and language acquisition, so he or she might stand for language education.
```
